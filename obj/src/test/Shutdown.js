...
class Shutdown {
    ...
    open(correlationId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let timeout = pip_services3_commons_nodex_1.RandomInteger.nextInteger(this._minTimeout, this._maxTimeout);
    ...
    shutdown() {
        if (this._mode == 'null' || this._mode == 'nullpointer') {
            ...
            let err = new pip_services3_commons_nodex_2.ApplicationException('test', null, 'CRASH', 'Crash test exception');
            throw err;
        }
    }
}
