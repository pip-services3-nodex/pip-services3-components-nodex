...
DefaultLoggerFactory.NullLoggerDescriptor = new pip_services3_commons_nodex_1.Descriptor("pip-services", "logger", "null", "*", "1.0");
DefaultLoggerFactory.ConsoleLoggerDescriptor = new pip_services3_commons_nodex_1.Descriptor("pip-services", "logger", "console", "*", "1.0");
DefaultLoggerFactory.CompositeLoggerDescriptor = new pip_services3_commons_nodex_1.Descriptor("pip-services", "logger", "composite", "*", "1.0");
