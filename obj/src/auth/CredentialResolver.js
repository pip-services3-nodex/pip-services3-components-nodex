...
class CredentialResolver {
    ...
    lookupInStores(correlationId, credential) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let storeDescriptor = new pip_services3_commons_nodex_2.Descriptor("*", "credential-store", "*", "*", "*");
            let stores = this._references.getOptional(storeDescriptor);
            if (stores.length == 0) {
                throw new pip_services3_commons_nodex_1.ReferenceException(correlationId, storeDescriptor);
            }
