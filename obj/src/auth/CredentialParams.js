 ...
 *
 * @see [[https://pip-services3-nodex.github.io/pip-services3-commons-nodex/classes/config.configparams.html ConfigParams]]
 ...
 */
class CredentialParams extends pip_services3_commons_nodex_1.ConfigParams {
    /**
    ...
    static fromTuples(...tuples) {
        let map = pip_services3_commons_nodex_2.StringValueMap.fromTuplesArray(tuples);
        return new CredentialParams(map);
    }
    /**
