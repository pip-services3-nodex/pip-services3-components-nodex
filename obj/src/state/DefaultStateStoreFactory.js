...
DefaultStateStoreFactory.Descriptor = new pip_services3_commons_nodex_1.Descriptor("pip-services", "factory", "state-store", "default", "1.0");
DefaultStateStoreFactory.NullStateStoreDescriptor = new pip_services3_commons_nodex_1.Descriptor("pip-services", "state-store", "null", "*", "1.0");
DefaultStateStoreFactory.MemoryStateStoreDescriptor = new pip_services3_commons_nodex_1.Descriptor("pip-services", "state-store", "memory", "*", "1.0");
