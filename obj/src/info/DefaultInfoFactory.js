...
DefaultInfoFactory.ContextInfoDescriptor = new pip_services3_commons_nodex_1.Descriptor("pip-services", "context-info", "default", "*", "1.0");
DefaultInfoFactory.ContainerInfoDescriptor = new pip_services3_commons_nodex_1.Descriptor("pip-services", "container-info", "default", "*", "1.0");
