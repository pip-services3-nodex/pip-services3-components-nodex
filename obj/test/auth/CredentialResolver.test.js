...
suite('CredentialResolver', () => {
    let RestConfig = pip_services3_commons_nodex_1.ConfigParams.fromTuples("credential.username", "Negrienko", "credential.password", "qwerty", "credential.access_key", "key", "credential.store_key", "store key");
    test('Configure', () => {
    ...
    test('Lookup', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        let RestConfigWithoutStoreKey = pip_services3_commons_nodex_1.ConfigParams.fromTuples("credential.username", "Negrienko", "credential.password", "qwerty", "credential.access_key", "key");
        ...
        credentialResolver = new CredentialResolver_1.CredentialResolver(RestConfig);
        credentialResolver.setReferences(new pip_services3_commons_nodex_2.References());
        try {
            credential = yield credentialResolver.lookup("correlationId");
            assert.fail("Expected to fail");
        }
