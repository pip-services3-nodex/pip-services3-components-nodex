...
suite('LogTracer', () => {
    ...
    setup(function () {
        ...
        _tracer.setReferences(pip_services3_commons_nodex_2.References.fromTuples(new pip_services3_commons_nodex_1.Descriptor("pip-services", "logger", "null", "default", "1.0"), new NullLogger_1.NullLogger()));
    });
    test('Simple Tracing', () => {
